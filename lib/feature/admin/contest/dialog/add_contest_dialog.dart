...
import 'package:admin_boda/feature/admin/contest/dialog/select_activity_dialog.dart';
import 'package:admin_boda/utils/constants/assets_manager.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:intl/intl.dart';

class AddContestDialog extends StatefulWidget {
  const AddContestDialog({super.key});

  @override
  State<AddContestDialog> createState() => _AddContestDialogState();
}

class _AddContestDialogState extends State<AddContestDialog> {
  final titleCtr = TextEditingController();
  final validFromCtr = TextEditingController();
  final validToCtr = TextEditingController();
  final selectActivityCtr = TextEditingController();
        ...
        body: Column(
          ...
          children: [
            ...
            CustomTextField(
              ...
              onTap: () {
                showCustomDialog(
                    context: context, content: const SelectActivityDialog());
              },
            ),
            CustomTextField(
              fillColor: context.whiteColor,
