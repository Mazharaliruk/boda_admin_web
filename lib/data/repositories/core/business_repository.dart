    ...
    switch (response.statusCode) {
      case 200:
        ...
        if (data is List) {
          ...
          return data.map<BusinessModel>((item) {
            if (item is Map<String, dynamic>) {
              print(item);
              return BusinessModel.fromMap(item);
            } else {
...
// Update category
Future<void> updateBusiness(BusinessModel data) async {
  final url = '${ApiUrls.business}/${data.id}';
