...
import 'package:admin_boda/models/core/service_model.dart';
...
Future<List<ServiceModel>> fetchService() async {
  const String url = ApiUrls.services;
    ...
    switch (response.statusCode) {
      case 200:
        ...
        if (data is List) {
          ...
          return data.map<ServiceModel>((item) {
            if (item is Map<String, dynamic>) {
              print(item);
              return ServiceModel.fromMap(item);
            } else {
...
Future<List<ServiceModel>> fetchOnlyOneService(int id) async {
   String url = '${ApiUrls.services}/$id';
...
// Update category
Future<void> updateService(ServiceModel data) async {
  final url = '${ApiUrls.services}/${data.id}';
