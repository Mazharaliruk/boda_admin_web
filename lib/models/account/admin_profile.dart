...
class AdminProfile {
  ...
  factory AdminProfile.fromJson(String source) => AdminProfile.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'AdminProfile(user: $user, profile_picture: $profile_picture, address: $address, name: $name, email: $email, phone: $phone, date_of_birth: $date_of_birth, role: $role, last_login: $last_login, created_at: $created_at, updated_at: $updated_at, is_active: $is_active)';
  }

  @override
  bool operator ==(covariant AdminProfile other) {
